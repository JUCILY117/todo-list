              ...
              <div className="max-sm:text-base font-semibold flex gap-4 items-center pt-4 pb-3">
                ...
                <div className="flex flex-wrap gap-3 max-sm:gap-2">
                  {details.catagory.map((val, index) => (
                    <p
                      className="text-left text-base bg-blue-900 border-purple-300 border-2 flex items-center gap-1 font-medium rounded-2xl px-3 py-1 max-sm:text-xs max-sm:py-0"
                      key={index}
                    >
