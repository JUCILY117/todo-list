...
const Todo = ({
  ...
  return (
    <div className="flex justify-between gap-4 max-w-full items-center text-white bg-blue-800 rounded-2xl px-8 py-5 max-sm:py-4 max-sm:px-4">
      {val.check && (
      ...
      <div className="black w-full">
        ...
        >
          {val.catagory.map((c, index) => (
            <h4
              className="bg-blue-900 rounded-2xl text-sm max-sm:text-xs px-3 flex items-center font-medium gap-1 py-1 max-sm:py-0"
              key={index}
            >
